...
document.addEventListener('DOMContentLoaded', function () {
  ...
  chrome.storage.local.get({
    ...
    document.getElementById('moveAwayFromCursor').checked = settings.moveAwayFromCursor;

    // Set random movement toggle
  ...
  function saveSettings() {
    ...
    const moveAwayFromCursor = document.getElementById('moveAwayFromCursor').checked;
